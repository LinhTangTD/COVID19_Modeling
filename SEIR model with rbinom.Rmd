...
p.test.sym.nv = 0.6 #percentage of testing for symptomatic group
p.test.asym.nv = 0.4 #percentage of testing for asymptomatic group
...
day.i = 5 #incubation period (days)
...
for (i in 0:100) {
  ...
  new.exposed.nv = rbinom(1, S.nv, I.rate.sym.nv * Isym.nv / N) + 
                   rbinom(1, S.nv, I.rate.asym.nv * Iasym.nv / N)
  #(S.nv/N) * (I.rate.sym.nv * Isym.nv + I.rate.asym.nv * Iasym.nv)
  quarantine.released.today.nv = rbinom(1, FQ.nv, 1/day.q)
  new.quarantined.nv = rbinom(1, S.nv, p.test.all.nv * p.fp.all.nv)
  new.infected.all.nv = rbinom(1, E.nv, E.rate) #total infected
    # infected symptomatic
  new.infected.sym.nv = rbinom(1, new.infected.all.nv, p.sym.nv)
  confirmed.sym.nv = rbinom(1, Isym.nv, p.test.sym.nv * p.tp.sym.nv) #tested & true positive
  ...
  confirmed.asym.nv = rbinom(1, Iasym.nv, p.test.asym.nv * p.tp.asym.nv)
  ...
  while ((H.to.R.nv + H.to.D.nv) > H.nv) {
    H.to.R.nv = rbinom(1, H.nv, R.rate.h.nv)
    H.to.D.nv = rbinom(1, H.nv, D.rate.h.nv) 
  }
...
p.test.asym.v = 0.4 #percentage of testing for asymptomatic group
...
R.rate.sym.v = .1 #recovery rate for symptomatic group
R.rate.asym.v = .15 #recovery rate for asymptomatic group
R.rate.h.v = .08 #recovery rate for hospitalized group
D.rate.sym.v = .1 #death rate for symptomatic group
D.rate.asym.v = .1 #death rate for asymptomatic group
D.rate.h.v = .15 #death rate for hospitalized group
...
for (i in 0:100) {
  ...
  ### Immediate calculations (for next day statistics)
  new.exposed.v = rbinom(1, S.v, I.rate.sym.v * Isym.v / N) +
                  rbinom(1, S.v, I.rate.asym.v * Iasym.v / N)
  ##(S.v/N) * (I.rate.sym.v * Isym.v + I.rate.asym.v * Iasym.v)
  quarantine.released.today.v = rbinom(1, FQ.v, 1/day.q)
  new.quarantined.v = rbinom(1, S.v, p.test.all.v * p.fp.all.v)
  new.infected.all.v = rbinom(1, E.v, E.rate) #total infected
    # infected symptomatic
  new.infected.sym.v = rbinom(1, new.infected.all.v, p.sym.v)
  confirmed.sym.v = rbinom(1, Isym.v, p.test.sym.v * p.tp.sym.v) #tested & true positive
  ...
  confirmed.asym.v = rbinom(1, Iasym.v, p.test.asym.v * p.tp.asym.v)
...
for (i in 0:100) {
  ...
  ### Immediate calculations (for next day statistics)
  new.exposed.nv = min(rbinom(1, S.nv, I.rate.sym * Isym.v / N) +
...
#(S.nv/N) * (I.rate.sym * Isym.nv + I.rate.asym * Iasym.nv + I.rate.sym * Isym.v + I.rate.asym * Iasym.v)
  ...
  nonconfirmed.sym.to.R.nv = rbinom(1, nonconfirmed.sym.nv, R.rate.sym.nv)
  nonconfirmed.sym.to.D.nv = rbinom(1, nonconfirmed.sym.nv, D.rate.sym.nv)
    while (nonconfirmed.sym.to.H.nv + nonconfirmed.sym.to.R.nv + nonconfirmed.sym.to.D.nv > noncomfirmed.sym.nv) {
      nonconfirmed.sym.to.H.nv = rbinom(1, nonconfirmed.sym.nv, H.rate.nv)
      nonconfirmed.sym.to.R.nv = rbinom(1, nonconfirmed.sym.nv, R.rate.sym.nv)
      nonconfirmed.sym.to.D.nv = rbinom(1, nonconfirmed.sym.nv, D.rate.sym.nv)
    }
  ...
  ### Immediate calculations (for next day statistics)
  new.exposed.v =  min(rbinom(1, S.nv, I.rate.sym * Isym.v / N) +
                   rbinom(1, S.nv, I.rate.asym * Iasym.v / N) +
                   rbinom(1, S.nv, I.rate.sym * Isym.nv / N) + 
                   rbinom(1, S.nv, I.rate.asym * Iasym.nv), N, S.nv)
